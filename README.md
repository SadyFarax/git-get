...
- [ویژگی‌ها](#-ویژگیها)
- [شیوه استفاده](#-شیوه-استفاده)
  - [۱. راه‌اندازی گردش کار (Workflow)](#۱-راهاندازی-گردش-کار-workflow)
  - [۲. تعریف وظایف (TASKS_JSON)](#۲-تعریف-وظایف-tasks_json)
    - [دانلود مستقیم (direct)](#-دانلود-مستقیم-direct)
    - [کلون مخزن گیت (git)](#-کلون-مخزن-گیت-git)
    - [آینه‌سازی وبسایت (website)](#-آینهسازی-وبسایت-website)
  - [۳. اجرا](#۳-اجرا)
- [خروجی](#-خروجی)
- [سفارشی‌سازی](#-سفارشیسازی)
- [اجرای محلی (بدون گیتهاب)](#-اجرای-محلی-بدون-گیتهاب)
- [نکات مهم](#-نکات-مهم)
